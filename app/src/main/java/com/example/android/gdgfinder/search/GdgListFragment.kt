...
//        create observer for defining a ChipGroup and adding Chips
        viewModel.regionList.observe(viewLifecycleOwner, object : Observer<List<String>>{
            override fun onChanged(data: List<String>?) {
                data ?: return

//                create chipGroup and inflator variables
                val chipGroup = binding.regionList
                val inflator = LayoutInflater.from(chipGroup.context)

//                create chip for each regionList item
//                use map function to iterate over regionList and create chip for each item
//                return result as new list called childre
